...
> the backend spec issue #31 (the implementation contract) and `CLAUDE.md` (the
...
- [ ] **Naming note / deviation from backend spec issue #31:** the VectorIndex port interface is named
...
- No deviations from backend spec issue #31 were found.
